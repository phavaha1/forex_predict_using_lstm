...
def create_structured_training_set(training_data):
    X_train = []
    y_train = []
...
def create_structured_test_set(training_data, test_data):
    inputs = np.concatenate((training_data[-(TIME_STEP):], test_data))
...
def create_and_train_model(training_data):
    X_train, y_train = create_structured_test_set(training_data)
    lstm = LstmModel(X_train, y_train)
